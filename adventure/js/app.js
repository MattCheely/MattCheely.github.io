			...
			do {
				if (_p1._0.ctor === 'GoAdventure') {
					...
					if (_p1._1.ctor === 'CombatView') {
						var _p2 = _p1._1._0;
						var newModel = A3(_user$project$Combat$update, _p1._0._0, _p2, userId);
						return _elm_lang$core$Native_Utils.eq(newModel.status, _user$project$Combat$Victory) ? {
							...
							_1: _user$project$InterOp$showAchievement
						} : {
							ctor: '_Tuple2',
							_0: _user$project$Main$CombatView(newModel),
							_1: A2(_user$project$InterOp$saveCombat, 'asdf', _p2)
						};
					} else {
						break _v0_2;
					}
...
var _user$project$Main$init = function (config) {
	...
	var appModel = function () {
		var _p3 = charDecodeResult;
		if (_p3.ctor === 'Ok') {
			return _user$project$Main$WithCharacter(
				{character: _p3._0, route: _user$project$Main$CharacterView});
		} else {
...
var _user$project$Main$updateApp = F4(
	function (seed, userId, msg, appModel) {
		...
		_v2_2:
		do {
			if (_p4._0.ctor === 'SelectingCharacter') {
				if (_p4._1.ctor === 'CharacterSelected') {
					var $char = A2(_user$project$Creature$new, _p4._1._0, userId);
					return {
						ctor: '_Tuple2',
			...
			return A2(
				...
				function (_p7) {
					return _user$project$Main$AdventureEvent(
						_user$project$Main$CombatEvent(_p7));
				},
				A2(_user$project$Combat$view, userId, _p6._0));
		}
	});
var _user$project$Main$view = function (model) {
	var _p8 = model.appModel;
	if (_p8.ctor === 'SelectingCharacter') {
		return _user$project$Main$characterSelectionView;
	} else {
		return A2(_user$project$Main$adventureView, model.userId, _p8._0);
	}
};
