...
var _user$project$Creature$encode = function (creature) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				...
				_1: _elm_lang$core$Json_Encode$string(
					_elm_lang$core$Basics$toString(creature.creatureType))
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'hitPoints',
					_1: _elm_lang$core$Json_Encode$int(creature.hitPoints)
				},
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Creature$creatureImg = function ($class) {
	var _p0 = $class;
	switch (_p0.ctor) {
		case 'Wizard':
...
var _user$project$Creature$maxHp = function ($class) {
	var _p1 = $class;
	switch (_p1.ctor) {
		case 'Wizard':
			return 6;
...
var _user$project$Creature$health = function (creature) {
	return (_elm_lang$core$Native_Utils.cmp(creature.hitPoints, 0) < 0) ? 0 : ((_elm_lang$core$Basics$toFloat(creature.hitPoints) / _elm_lang$core$Basics$toFloat(
		_user$project$Creature$maxHp(creature.creatureType))) * 100);
};
var _user$project$Creature$showSprite = function (creature) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('creature'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$img,
				{
					...
					_0: _elm_lang$html$Html_Attributes$src(
						_user$project$Creature$creatureImg(creature.creatureType)),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('creatureStats'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('hpImage'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$src('images/hp.png'),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('progressBar'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
												...
												_0: _elm_lang$html$Html_Attributes$style(
													{
														...
														_0: {
															...
															_1: A2(
																_elm_lang$core$Basics_ops['++'],
																_elm_lang$core$Basics$toString(
																	_user$project$Creature$health(creature)),
																'%')
														},
														_1: {ctor: '[]'}
													}),
...
var _user$project$Creature$new = F2(
	function (creatureType, id) {
		return {
			creatureType: creatureType,
			id: id,
			hitPoints: _user$project$Creature$maxHp(creatureType)
		};
	});
var _user$project$Creature$isSame = F2(
	function (c1, c2) {
		return _elm_lang$core$Native_Utils.eq(c1.id, c2.id);
	});
var _user$project$Creature$Creature = F3(
	function (a, b, c) {
		return {creatureType: a, id: b, hitPoints: c};
	});
var _user$project$Creature$Attack = F3(
	function (a, b, c) {
		return {attacker: a, victim: b, result: c};
	});
var _user$project$Creature$Wizard = {ctor: 'Wizard'};
var _user$project$Creature$Fighter = {ctor: 'Fighter'};
var _user$project$Creature$Goblin = {ctor: 'Goblin'};
var _user$project$Creature$isNPC = function (creature) {
	return _elm_lang$core$Native_Utils.eq(creature.creatureType, _user$project$Creature$Goblin);
};
var _user$project$Creature$typeDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (string) {
		var _p2 = string;
		switch (_p2) {
			case 'Fighter':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Creature$Fighter);
			case 'Wizard':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Creature$Wizard);
			case 'Goblin':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Creature$Goblin);
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unrecognized creature type: ', _p2));
		}
	},
	_elm_lang$core$Json_Decode$string);
var _user$project$Creature$decoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Creature$Creature,
	A2(_elm_lang$core$Json_Decode$field, 'creatureType', _user$project$Creature$typeDecoder),
	A2(_elm_lang$core$Json_Decode$field, 'player', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'hitPoints', _elm_lang$core$Json_Decode$int));
var _user$project$Creature$Miss = {ctor: 'Miss'};
var _user$project$Creature$Hit = function (a) {
	return {ctor: 'Hit', _0: a};
};
var _user$project$Creature$attack = F3(
	function (attacker, victim, seed) {
		var damageGenerator = function () {
			var _p3 = attacker.creatureType;
			switch (_p3.ctor) {
				case 'Wizard':
					return A2(_elm_lang$core$Random$int, 0, 4);
				case 'Fighter':
					return A2(_elm_lang$core$Random$int, 0, 2);
				default:
					return A2(_elm_lang$core$Random$int, 0, 1);
			}
		}();
...
var _user$project$Combat$encode = function (model) {
	return _elm_lang$core$Json_Encode$object(
		{ctor: '[]'});
};
...
var _user$project$Combat$inParty = F2(
	function (model, creature) {
		return A2(_elm_lang$core$List$member, creature.id, model.party);
	});
var _user$project$Combat$getParty = function (model) {
	return A2(
		_elm_lang$core$List$filter,
		_user$project$Combat$inParty(model),
		model.turnOrder);
};
var _user$project$Combat$getEnemies = function (model) {
	return A2(
		_elm_lang$core$List$filter,
		function (_p0) {
			return !A2(_user$project$Combat$inParty, model, _p0);
		},
		model.turnOrder);
};
var _user$project$Combat$activeCreatureId = function (model) {
	return A2(
		_elm_lang$core$Maybe$map,
		function (_) {
			return _.id;
		},
		A2(_elm_community$list_extra$List_Extra$getAt, model.turn, model.turnOrder));
};
var _user$project$Combat$isPlayerTurn = F2(
	function (model, userId) {
		return _elm_lang$core$Native_Utils.eq(
			_user$project$Combat$activeCreatureId(model),
			_elm_lang$core$Maybe$Just(userId));
	});
var _user$project$Combat$updateCombatant = F2(
	function (combatant, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				turnOrder: A3(
					...
					function (creature) {
						return _elm_lang$core$Native_Utils.eq(creature.id, combatant.id);
					},
					combatant,
					model.turnOrder)
			});
	});
var _user$project$Combat$getCombatant = F2(
	function (model, id) {
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (combatant) {
					return _elm_lang$core$Native_Utils.eq(combatant.id, id);
				},
				model.turnOrder));
	});
var _user$project$Combat$Model = F6(
	function (a, b, c, d, e, f) {
...
var _user$project$Combat$gameStatus = F2(
	function (model, userId) {
		var enemies = _user$project$Combat$getEnemies(model);
		var playerChar = A2(_user$project$Combat$getCombatant, model, userId);
		var _p1 = playerChar;
		if (_p1.ctor === 'Just') {
			return (_elm_lang$core$Native_Utils.cmp(_p1._0.hitPoints, 0) < 1) ? _user$project$Combat$Defeat : (A2(
				_elm_lang$core$List$all,
				function (enemy) {
					return _elm_lang$core$Native_Utils.cmp(enemy.hitPoints, 0) < 1;
				},
				enemies) ? _user$project$Combat$Victory : _user$project$Combat$Ongoing);
		} else {
			return _user$project$Combat$Defeat;
		}
	});
var _user$project$Combat$handleAttack = F4(
	function (userId, attackerId, victimId, model) {
		var foundVictim = A2(_user$project$Combat$getCombatant, model, victimId);
		var foundAttacker = A2(_user$project$Combat$getCombatant, model, attackerId);
		var _p2 = {ctor: '_Tuple2', _0: foundAttacker, _1: foundVictim};
		if ((_p2._0.ctor === 'Just') && (_p2._1.ctor === 'Just')) {
			var _p3 = A3(_user$project$Creature$attack, _p2._0._0, _p2._1._0, model.randomSeed);
			var attackResult = _p3._0;
			var newSeed = _p3._1;
			var modelWithDamage = A2(
				_user$project$Combat$updateCombatant,
				attackResult.victim,
				A2(_user$project$Combat$updateCombatant, attackResult.attacker, model));
			var status = A2(_user$project$Combat$gameStatus, modelWithDamage, userId);
			return _elm_lang$core$Native_Utils.update(
				modelWithDamage,
				{
					turn: A2(
						_elm_lang$core$Basics_ops['%'],
						model.turn + 1,
						_elm_lang$core$List$length(model.turnOrder)),
					turnHistory: {ctor: '::', _0: attackResult, _1: model.turnHistory},
					randomSeed: newSeed,
					status: status
				});
		} else {
			return A2(_elm_lang$core$Debug$log, 'Who you attacking bro?', model);
		}
	});
var _user$project$Combat$doNPCAttack = F4(
	function (userId, victimId, creature, model) {
		return A4(_user$project$Combat$handleAttack, userId, creature.id, victimId, model);
	});
var _user$project$Combat$doNPCAttacks = F2(
	function (userId, model) {
		var upcomingNPCs = A2(
			_elm_community$list_extra$List_Extra$takeWhile,
			_user$project$Creature$isNPC,
			_elm_lang$core$List$concat(
				{
					ctor: '::',
					_0: A2(_elm_lang$core$List$drop, model.turn, model.turnOrder),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$core$List$take, model.turn, model.turnOrder),
						_1: {ctor: '[]'}
					}
				}));
		return A3(
			_elm_lang$core$List$foldl,
			A2(_user$project$Combat$doNPCAttack, userId, userId),
			model,
			upcomingNPCs);
	});
	...
	function (msg, model, userId) {
		...
		if (_p4.ctor === 'PlayerAttack') {
			...
			return {
				ctor: '_Tuple2',
				_0: newModel,
				_1: hadHit ? _elm_lang$core$Maybe$Just('hit') : _elm_lang$core$Maybe$Nothing
			};
		} else {
			return {
				ctor: '_Tuple2',
...
var _user$project$Combat$showEnemy = F4(
	function (isPlayerTurn, playerType, attacks, enemy) {
		...
		var baseElement = isPlayerTurn ? _elm_lang$html$Html$button(
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'enemy ', attackClass)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Combat$PlayerAttack(enemy.id)),
					_1: {ctor: '[]'}
				}
			}) : _elm_lang$html$Html$div(
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('enemy'),
				_1: {ctor: '[]'}
			});
		return baseElement(
			{
...
var _user$project$Combat$combat = F2(
	function (model, userId) {
		var playerType = A2(
			...
			_user$project$Creature$Fighter,
			A2(
				_elm_lang$core$Maybe$map,
				function (_) {
					return _.creatureType;
				},
				A2(_user$project$Combat$getCombatant, model, userId)));
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('characterDisplay'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('enemies faceLeft'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
		...
		switch (_p8.ctor) {
			...
			case 'Defeat':
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Defeat'),
						_1: {ctor: '[]'}
					});
			default:
				return A2(_user$project$Combat$combat, model, userId);
		}
	});

var _user$project$InterOp$toJs = _elm_lang$core$Native_Platform.outgoingPort(
	'toJs',
	function (v) {
		return v;
	});
var _user$project$InterOp$saveCharacter = F2(
	function (userId, $char) {
		return _user$project$InterOp$toJs(
			_elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'action',
						_1: _elm_lang$core$Json_Encode$string('saveCharacter')
					},
					_1: {
						ctor: '::',
						_0: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'character',
								_1: _user$project$Creature$encode($char)
							},
							_1: {ctor: '[]'}
						}
					}
...
var _user$project$InterOp$saveCombat = F2(
			...
			_elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'action',
						_1: _elm_lang$core$Json_Encode$string('saveCombat')
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'combatId',
							_1: _elm_lang$core$Json_Encode$string(combatId)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'combat',
								_1: _user$project$Combat$encode(combat)
							},
							_1: {ctor: '[]'}
						}
					}
...
var _user$project$InterOp$showAchievement = _user$project$InterOp$toJs(
	_elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'action',
				_1: _elm_lang$core$Json_Encode$string('showAchievement')
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'message',
					_1: _elm_lang$core$Json_Encode$string('Won your first battle')
				},
				_1: {ctor: '[]'}
			}
		}));
var _user$project$InterOp$playSound = function (name) {
	return _user$project$InterOp$toJs(
		_elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'action',
					_1: _elm_lang$core$Json_Encode$string('playSound')
				},
				_1: {
					ctor: '::',
					_0: {
...
var _user$project$InterOp$fromJs = _elm_lang$core$Native_Platform.incomingPort('fromJs', _elm_lang$core$Json_Decode$value);
...
var _user$project$Main$sound = function (name) {
	return A2(
		_elm_lang$html$Html$audio,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id(
				A2(_elm_lang$core$Basics_ops['++'], 'sound-', name)),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$src(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'sounds/',
						A2(_elm_lang$core$Basics_ops['++'], name, '.wav'))),
				_1: {ctor: '[]'}
			}
		},
		{ctor: '[]'});
};
var _user$project$Main$sounds = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _user$project$Main$sound('hit'),
		_1: {ctor: '[]'}
	});
...
var _user$project$Main$AdventureModel = F2(
	function (a, b) {
		return {character: a, route: b};
	});
var _user$project$Main$WithCharacter = function (a) {
	return {ctor: 'WithCharacter', _0: a};
};
var _user$project$Main$SelectingCharacter = {ctor: 'SelectingCharacter'};
...
var _user$project$Main$updateAdventure = F4(
	function (seed, userId, msg, model) {
		var _p0 = function () {
			...
			_v0_2:
			do {
				if (_p1._0.ctor === 'GoAdventure') {
					if (_p1._1.ctor === 'CharacterView') {
						return {
							ctor: '_Tuple2',
					...
					if (_p1._1.ctor === 'CombatView') {
						var _p4 = _p1._1._0;
						var _p2 = A3(_user$project$Combat$update, _p1._0._0, _p4, userId);
						var newModel = _p2._0;
						var sound = _p2._1;
						var soundCmd = function () {
							var _p3 = sound;
							if (_p3.ctor === 'Just') {
								return _user$project$InterOp$playSound(_p3._0);
							} else {
								return _elm_lang$core$Platform_Cmd$none;
							}
						}();
						return _elm_lang$core$Native_Utils.eq(newModel.status, _user$project$Combat$Victory) ? {
							ctor: '_Tuple2',
							_0: _user$project$Main$CombatView(newModel),
							_1: _elm_lang$core$Platform_Cmd$batch(
								{
									ctor: '::',
									_0: _user$project$InterOp$showAchievement,
									_1: {
										ctor: '::',
										_0: soundCmd,
										_1: {ctor: '[]'}
							...
							_1: _elm_lang$core$Platform_Cmd$batch(
								{
									ctor: '::',
									_0: A2(_user$project$InterOp$saveCombat, 'asdf', _p4),
									_1: {
										ctor: '::',
										_0: soundCmd,
										_1: {ctor: '[]'}
			...
			return {ctor: '_Tuple2', _0: model.route, _1: _elm_lang$core$Platform_Cmd$none};
		}();
		var updatedRoute = _p0._0;
		var cmd = _p0._1;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$Main$init = function (config) {
	...
	var appModel = function () {
		var _p5 = charDecodeResult;
		if (_p5.ctor === 'Ok') {
			return _user$project$Main$WithCharacter(
				{character: _p5._0, route: _user$project$Main$CharacterView});
		} else {
			return _user$project$Main$SelectingCharacter;
		}
	}();
	var token = A2(
		_elm_lang$core$Result$withDefault,
...
var _user$project$Main$updateApp = F4(
	function (seed, userId, msg, appModel) {
		var _p6 = {ctor: '_Tuple2', _0: appModel, _1: msg};
		_v3_2:
		do {
			if (_p6._0.ctor === 'SelectingCharacter') {
				if (_p6._1.ctor === 'CharacterSelected') {
					var $char = A2(_user$project$Creature$new, _p6._1._0, userId);
					return {
						ctor: '_Tuple2',
						_0: _user$project$Main$WithCharacter(
							{character: $char, route: _user$project$Main$CharacterView}),
						_1: A2(_user$project$InterOp$saveCharacter, userId, $char)
					};
				} else {
					break _v3_2;
				}
			} else {
				if (_p6._1.ctor === 'AdventureEvent') {
					return A2(
						_elm_lang$core$Tuple$mapFirst,
						_user$project$Main$WithCharacter,
						A4(_user$project$Main$updateAdventure, seed, userId, _p6._1._0, _p6._0._0));
				} else {
					break _v3_2;
				}
			}
		...
		return A2(
			...
			{ctor: '_Tuple2', _0: appModel, _1: _elm_lang$core$Platform_Cmd$none});
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p7 = A4(_user$project$Main$updateApp, model.seed, model.userId, msg, model.appModel);
		var appModel = _p7._0;
		var cmd = _p7._1;
		return {
			ctor: '_Tuple2',
...
var _user$project$Main$AdventureEvent = function (a) {
	return {ctor: 'AdventureEvent', _0: a};
};
var _user$project$Main$CharacterSelected = function (a) {
	return {ctor: 'CharacterSelected', _0: a};
};
var _user$project$Main$characterSelectionView = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Choose your character!'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
				...
				},
				{
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Main$CharacterSelected(_user$project$Creature$Wizard)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Wizard!'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$button,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Main$CharacterSelected(_user$project$Creature$Fighter)),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Fighter!'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Main$CombatEvent = function (a) {
	return {ctor: 'CombatEvent', _0: a};
};
var _user$project$Main$GoAdventure = {ctor: 'GoAdventure'};
var _user$project$Main$adventureView = F2(
	function (userId, model) {
		var _p8 = model.route;
		if (_p8.ctor === 'CharacterView') {
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				{
						...
						},
						{
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Main$AdventureEvent(_user$project$Main$GoAdventure)),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Adventure!'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _user$project$Main$characterView(model.character),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
			...
			return A2(
				...
				function (_p9) {
					return _user$project$Main$AdventureEvent(
						_user$project$Main$CombatEvent(_p9));
				},
				A2(_user$project$Combat$view, userId, _p8._0));
		}
	});
var _user$project$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			ctor: '::',
			_0: function () {
				var _p10 = model.appModel;
				if (_p10.ctor === 'SelectingCharacter') {
					return _user$project$Main$characterSelectionView;
				} else {
					return A2(_user$project$Main$adventureView, model.userId, _p10._0);
				}
			}(),
			_1: {
				ctor: '::',
				_0: _user$project$Main$sounds,
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Main$init, update: _user$project$Main$update, view: _user$project$Main$view, subscriptions: _user$project$Main$subs})(_elm_lang$core$Json_Decode$value);

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.AdventureMsg":{"args":[],"tags":{"CombatEvent":["Combat.Msg"],"GoAdventure":[]}},"Creature.CreatureType":{"args":[],"tags":{"Wizard":[],"Goblin":[],"Fighter":[]}},"Combat.Msg":{"args":[],"tags":{"PlayerAttack":["String"],"ClearAttacks":["String"]}},"Main.Msg":{"args":[],"tags":{"AdventureEvent":["Main.AdventureMsg"],"CharacterSelected":["Creature.CreatureType"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
