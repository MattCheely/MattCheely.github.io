...
var _user$project$GifSearch$subs = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$GifSearch$searchDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'data',
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$GifSearch$notFoundImg = 'https://media.giphy.com/media/26xBIygOcC3bAWg3S/giphy.gif';
var _user$project$GifSearch$giphyKey = 'vSKgXSeeaqqZZMy4huWtGhiJfygTmtpC';
var _user$project$GifSearch$init = {
	ctor: '_Tuple2',
	_0: {imgUrl: _user$project$GifSearch$notFoundImg, searchTerm: ''},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$GifSearch$Model = F2(
	function (a, b) {
		return {imgUrl: a, searchTerm: b};
	});
var _user$project$GifSearch$SearchResults = function (a) {
	return {ctor: 'SearchResults', _0: a};
};
var _user$project$GifSearch$search = function (tag) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$GifSearch$SearchResults,
		A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					tag,
					A2(_elm_lang$core$Basics_ops['++'], '&rating=g&api_key=', _user$project$GifSearch$giphyKey))),
			_user$project$GifSearch$searchDecoder));
};
var _user$project$GifSearch$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NewSearchTerm':
				var _p1 = _p0._0;
				return _elm_lang$core$Native_Utils.eq(_p1, 'cat') ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{searchTerm: 'opossum'}),
					_1: _user$project$GifSearch$search('opossum')
				} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'DoSearch':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$GifSearch$search(model.searchTerm)
				};
			default:
				var url = A2(_elm_lang$core$Result$withDefault, _user$project$GifSearch$notFoundImg, _p0._0);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$GifSearch$NewSearchTerm = function (a) {
	return {ctor: 'NewSearchTerm', _0: a};
};
var _user$project$GifSearch$DoSearch = {ctor: 'DoSearch'};
var _user$project$GifSearch$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('cat-picker'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('cat-image'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src(model.imgUrl),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {ctor: '[]'}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onSubmit(_user$project$GifSearch$DoSearch),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$defaultValue(model.searchTerm),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$GifSearch$NewSearchTerm),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
...
var _user$project$GifSearch$main = _elm_lang$html$Html$program(
	{init: _user$project$GifSearch$init, update: _user$project$GifSearch$update, view: _user$project$GifSearch$view, subscriptions: _user$project$GifSearch$subs})();

var Elm = {};
Elm['GifSearch'] = Elm['GifSearch'] || {};
if (typeof _user$project$GifSearch$main !== 'undefined') {
    _user$project$GifSearch$main(Elm['GifSearch'], 'GifSearch', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"GifSearch.Msg":{"args":[],"tags":{"NewSearchTerm":["String"],"SearchResults":["Result.Result Http.Error String"],"DoSearch":[]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"}},"message":"GifSearch.Msg"},"versions":{"elm":"0.18.0"}});
}
