...
var author$project$Main$PresentAction = function (a) {
	return {$: 'PresentAction', a: a};
};
var author$project$Component$ButtonClicked = {$: 'ButtonClicked'};
var author$project$Component$ToggleFlipped = function (a) {
	return {$: 'ToggleFlipped', a: a};
};
...
var author$project$Component$accordion = elm$html$Html$node('gux-accordion');
var author$project$Component$button = elm$html$Html$node('gux-button');
...
var author$project$Component$slot = elm$html$Html$Attributes$attribute('slot');
var author$project$Component$textAttr = elm$html$Html$Attributes$attribute('text');
var author$project$Component$toggle = elm$html$Html$node('gux-toggle');
...
var author$project$Component$componentDemo = A2(
	author$project$Component$accordion,
	_List_Nil,
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					author$project$Component$slot('First Section')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$text('Here\'s a button:  ')
						])),
					A2(
					author$project$Component$button,
					_List_fromArray(
						[
							author$project$Component$textAttr('Click Me!'),
							elm$html$Html$Events$onClick(author$project$Component$ButtonClicked)
						]),
					_List_Nil)
				])),
			A2(
			...
			_List_fromArray(
				[
					author$project$Component$slot('Second Section')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$text('Here\'s a toggle: ')
						])),
					A2(
					author$project$Component$toggle,
					_List_fromArray(
						[
							elm$html$Html$Events$onCheck(author$project$Component$ToggleFlipped)
						]),
					_List_Nil)
				]))
		]));
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Embedding our web components was nearly trivial!')
							])),
						A2(
						elm$html$Html$div,
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('bound-data')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										elm$html$Html$text('Button Clicked '),
										elm$html$Html$text(
										elm$core$String$fromInt(model.buttonClicked)),
								...
								_List_fromArray(
									[
										elm$html$Html$text('Toggle is '),
										model.toggleState ? elm$html$Html$text('on.') : elm$html$Html$text('off.')
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('component-demo')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('component-rendering')
							]),
						_List_fromArray(
							[author$project$Component$componentDemo]))
					]))
			]));
};
...
var author$project$Content$techIcon = function (path) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('tech-icon')
			]),
		_List_fromArray(
			[
				A2(
...
var author$project$Content$angular = author$project$Content$techIcon('angular.svg');
var author$project$Content$angularjs = author$project$Content$techIcon('angularjs.png');
var author$project$Content$elm = author$project$Content$techIcon('elm.svg');
var author$project$Content$ember = author$project$Content$techIcon('ember.png');
...
var author$project$Content$historyColumn = function (element) {
	return A2(
...
var author$project$Content$historyRow = function (columns) {
	return A2(
		...
		A2(elm$core$List$map, author$project$Content$historyColumn, columns));
};
var author$project$Content$knockout = author$project$Content$techIcon('knockout.png');
...
var author$project$Content$productIcon = function (url) {
	return A2(
		...
		{description: 'Pure Cloud', src: url});
};
...
var author$project$Content$techList = function (libraries) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var author$project$Content$pureCloudHistory = author$project$Content$historyRow(
	_List_fromArray(
		[
			author$project$Content$productIcon('PureCloud.png'),
			author$project$Content$techList(
			_List_fromArray(
				[author$project$Content$knockout])),
			author$project$Content$techList(
			_List_fromArray(
				[author$project$Content$knockout, author$project$Content$ember])),
			author$project$Content$techList(
			_List_fromArray(
				[author$project$Content$ember, author$project$Content$knockout, author$project$Content$angularjs])),
			author$project$Content$techList(
			_List_fromArray(
				[author$project$Content$ember, author$project$Content$knockout])),
			author$project$Content$techList(
			_List_fromArray(
				[author$project$Content$ember, author$project$Content$knockout, author$project$Content$elm])),
			author$project$Content$techList(
			_List_fromArray(
				[author$project$Content$ember, author$project$Content$knockout, author$project$Content$angular, author$project$Content$elm]))
		]));
var author$project$Content$pureConnectHistory = author$project$Content$historyRow(
	_List_fromArray(
		[
			author$project$Content$productIcon('PureConnect.png'),
			author$project$Content$techList(
			_List_fromArray(
				[author$project$Content$angularjs])),
			author$project$Content$techList(
			_List_fromArray(
				[author$project$Content$angularjs])),
			author$project$Content$techList(
			...
			author$project$Content$techList(
			_List_fromArray(
				[author$project$Content$angular, author$project$Content$angularjs])),
			author$project$Content$techList(
			_List_fromArray(
				[author$project$Content$angular, author$project$Content$angularjs]))
		]));
var author$project$Content$pureEngageHistory = author$project$Content$historyRow(
	_List_fromArray(
		[
			author$project$Content$productIcon('PureEngage.png'),
			author$project$Content$techList(_List_Nil),
			author$project$Content$techList(_List_Nil),
			author$project$Content$techList(_List_Nil),
			author$project$Content$techList(_List_Nil),
			author$project$Content$techList(_List_Nil),
...
var author$project$Content$uitext = mdgriffith$elm_ui$Element$text;
var elm$core$Basics$composeR = F3(
	function (f, g, x) {
		return g(
			f(x));
	});
var author$project$Content$yearLabels = function (years) {
	return author$project$Content$historyRow(
		_Utils_ap(
			_List_fromArray(
				[
					A2(
					mdgriffith$elm_ui$Element$el,
					_List_Nil,
					author$project$Content$uitext(' '))
				]),
			A2(
				elm$core$List$map,
				A2(elm$core$Basics$composeR, elm$core$String$fromInt, author$project$Content$uitext),
				years)));
};
...
var author$project$Content$history = A2(
	...
	_List_fromArray(
		[
			author$project$Content$pureEngageHistory,
			author$project$Content$pureConnectHistory,
			author$project$Content$pureCloudHistory,
			author$project$Content$yearLabels(
			_List_fromArray(
				[2013, 2014, 2015, 2016, 2017, 2018]))
		]));
var author$project$Content$teamList = function (people) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('team-list')
			]),
		A2(
			elm$core$List$map,
			function (_n0) {
...
var author$project$Content$titlePage = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('title-page')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('g-logo'),
							elm$html$Html$Attributes$src('logo-white.svg')
						]),
					_List_Nil),
					A2(
					elm$html$Html$div,
					...
					_List_fromArray(
						[
							elm$html$Html$text('Common UI: Bringing the advantages of microservices to front-end development')
						]))
				])),
			A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('small-section')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('genesys-small'),
							elm$html$Html$Attributes$src('logo-small.gif')
						]),
					_List_Nil),
					A2(
					elm$html$Html$div,
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('small-divider')
						]),
					_List_Nil),
					A2(
					elm$html$Html$div,
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('pko-text')
						]),
					_List_fromArray(
						[
							elm$html$Html$text('PKO19')
						]))
				]))
		]));
var author$project$Presentation$Static = function (a) {
	return {$: 'Static', a: a};
};
var author$project$Presentation$asSlide = function (html) {
	return author$project$Presentation$Static(html);
};
var elm$core$Basics$pow = _Basics_pow;
var author$project$Sim$calculateBugImpact = function (model) {
	var seriousIssueRate = model.seriousIssuePercent / 100;
	var projectCount = model.projectCount;
	var noIssueProbability = A2(elm$core$Basics$pow, 1 - seriousIssueRate, projectCount);
	var issueProbability = 1 - noIssueProbability;
	var featureRate = model.majorFeaturePercent / 100;
	var expectedFeaturesPerWeek = featureRate * projectCount;
	var expectedGoodFeatures = (noIssueProbability * expectedFeaturesPerWeek) * 52;
	var expectedYearlyFeatures = expectedFeaturesPerWeek * 52;
	var expectedBadFeatures = ((seriousIssueRate * featureRate) * projectCount) * 52;
	var expectedImpactedFeatures = (expectedYearlyFeatures - expectedGoodFeatures) - expectedBadFeatures;
	return {badFeatures: expectedBadFeatures, goodFeatures: expectedGoodFeatures, impactedFeatures: expectedImpactedFeatures, yearlyFeatures: expectedYearlyFeatures};
};
var author$project$Sim$DoSim = {$: 'DoSim'};
var author$project$Sim$UpdateFeaturePercent = function (a) {
	return {$: 'UpdateFeaturePercent', a: a};
};
...
var author$project$Sim$intSetting = function (opts) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('range-setting')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$for(opts.id)
					]),
				_List_fromArray(
					[
						elm$html$Html$text(opts.label)
					])),
				A2(
				elm$html$Html$input,
				_List_fromArray(
					[
						elm$html$Html$Attributes$id(opts.id),
						elm$html$Html$Attributes$type_('range'),
						elm$html$Html$Attributes$min(
						elm$core$String$fromInt(opts.min)),
						elm$html$Html$Attributes$max(
						elm$core$String$fromInt(opts.max)),
						elm$html$Html$Attributes$step('1'),
						elm$html$Html$Attributes$value(
						elm$core$String$fromInt(opts.currentValue)),
						elm$html$Html$Events$onInput(opts.onChange)
					]),
				_List_Nil),
				A2(
				elm$html$Html$span,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('val-display')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(
						opts.formatter(opts.currentValue))
					]))
			]));
};
var author$project$Sim$featureShipRateSetting = function (featurePercent) {
	return author$project$Sim$intSetting(
		{
			...
			max: 100,
			min: 1,
			onChange: author$project$Sim$UpdateFeaturePercent
		});
};
var author$project$Sim$UpdateIssuePercent = function (a) {
	return {$: 'UpdateIssuePercent', a: a};
};
var author$project$Sim$issuePercentSetting = function (issuePercent) {
	return author$project$Sim$intSetting(
		{
			...
			max: 100,
			min: 1,
			onChange: author$project$Sim$UpdateIssuePercent
		});
};
var author$project$Sim$UpdateProjectCount = function (a) {
	return {$: 'UpdateProjectCount', a: a};
};
var author$project$Sim$projectCountSetting = function (projectCount) {
	return author$project$Sim$intSetting(
		{currentValue: projectCount, formatter: elm$core$String$fromInt, id: 'projectCount', label: 'Project Count', max: 25, min: 1, onChange: author$project$Sim$UpdateProjectCount});
};
var elm$html$Html$button = _VirtualDom_node('button');
var elm$html$Html$h1 = _VirtualDom_node('h1');
var author$project$Sim$settingsView = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Product Release Parameters')
					])),
				author$project$Sim$projectCountSetting(model.projectCount),
				author$project$Sim$featureShipRateSetting(model.majorFeaturePercent),
				author$project$Sim$issuePercentSetting(model.seriousIssuePercent),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('refresh-sim'),
								elm$html$Html$Events$onClick(author$project$Sim$DoSim)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('Re-Run')
							]))
					]))
			]));
};
var author$project$Sim$hasIssue = function (weekSim) {
	return A2(
		elm$core$List$any,
		function ($) {
			return $.seriousIssue;
...
var author$project$Sim$legendItem = F4(
	function (extraClass, label, count, expected) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('legend-item')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('release ' + extraClass)
						]),
					_List_Nil),
					A2(
					elm$html$Html$span,
					...
					_List_fromArray(
						[
							elm$html$Html$text(
							' ' + (elm$core$String$fromInt(count) + (' ' + (label + (' (' + (elm$core$String$fromInt(expected) + ' expected)'))))))
						]))
				]));
	});
var author$project$Sim$weekBadFeatureCount = function (weekSim) {
	return elm$core$List$length(
		A2(
			elm$core$List$filter,
			function (p) {
				return p.majorFeature && p.seriousIssue;
			},
			weekSim.projects));
};
var author$project$Sim$weekFeatureCount = function (weekSim) {
	return elm$core$List$length(
		A2(
			elm$core$List$filter,
			function ($) {
...
var author$project$Sim$simSummary = F2(
	function (expected, sim) {
		var successfulFeatureCount = elm$core$List$sum(
			A2(
				elm$core$List$map,
				author$project$Sim$weekFeatureCount,
				A2(
					elm$core$List$filter,
					A2(elm$core$Basics$composeL, elm$core$Basics$not, author$project$Sim$hasIssue),
					sim.weeks)));
		var featureCount = elm$core$List$sum(
			A2(elm$core$List$map, author$project$Sim$weekFeatureCount, sim.weeks));
		var badFeatureCount = elm$core$List$sum(
			A2(elm$core$List$map, author$project$Sim$weekBadFeatureCount, sim.weeks));
		var impactedFeatureCount = (featureCount - successfulFeatureCount) - badFeatureCount;
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('release-legend')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$text('Simulated Year')
						])),
					A4(
					author$project$Sim$legendItem,
					'all-types',
					'Completed Features',
					featureCount,
					elm$core$Basics$round(expected.yearlyFeatures)),
					A4(
					author$project$Sim$legendItem,
					'',
					'Successful Feature Releases',
					successfulFeatureCount,
					elm$core$Basics$round(expected.goodFeatures)),
					A4(
					author$project$Sim$legendItem,
					'has-issue',
					'Release-Impacted Features',
					badFeatureCount,
					elm$core$Basics$round(expected.badFeatures)),
					A4(
					author$project$Sim$legendItem,
					'was-impacted',
					'Features Impacted by Other Projects',
					impactedFeatureCount,
					elm$core$Basics$round(expected.impactedFeatures))
				]));
	});
...
var author$project$Sim$projectVis = function (project) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('release', true),
						_Utils_Tuple2('has-issue', project.seriousIssue),
						_Utils_Tuple2('has-feature', project.majorFeature)
					]))
			]),
		_List_Nil);
};
var author$project$Sim$weekVis = F2(
	function (idx, weekSim) {
		var week = idx + 1;
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('week-sim', true),
							_Utils_Tuple2(
							'has-issue',
							author$project$Sim$hasIssue(weekSim))
						]))
				]),
			A2(
				elm$core$List$cons,
				A2(
					...
					_List_fromArray(
						[
							elm$html$Html$text(
							elm$core$String$fromInt(week))
						])),
				A2(elm$core$List$map, author$project$Sim$projectVis, weekSim.projects)));
	});
var author$project$Sim$weeklyBreakdown = function (sim) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Weekly Release Events')
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('year-sim')
					]),
				A2(elm$core$List$indexedMap, author$project$Sim$weekVis, sim.weeks))
			]));
};
var author$project$Sim$view = function (model) {
	var expectedImpact = author$project$Sim$calculateBugImpact(model);
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('sim')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('sim-options')
					]),
				_List_fromArray(
					[
						author$project$Sim$settingsView(model),
						A2(
						elm$core$Maybe$withDefault,
						elm$html$Html$text(''),
						A2(
							elm$core$Maybe$map,
							author$project$Sim$simSummary(expectedImpact),
							model.simResult))
					])),
				A2(
				elm$core$Maybe$withDefault,
				elm$html$Html$text(''),
				A2(elm$core$Maybe$map, author$project$Sim$weeklyBreakdown, model.simResult))
			]));
};
var author$project$Presentation$Live = function (a) {
	return {$: 'Live', a: a};
};
var author$project$Presentation$dynamicSlide = function (viewFn) {
	return author$project$Presentation$Live(viewFn);
};
var author$project$Slides$dynamic = function (viewFn) {
	return author$project$Presentation$dynamicSlide(viewFn);
};
var elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var elm$html$Html$Attributes$style = elm$virtual_dom$VirtualDom$style;
var author$project$Slides$centered = function (html) {
	return author$project$Presentation$asSlide(
		A2(
			elm$html$Html$div,
			_List_fromArray(
				[
...
var author$project$Slides$md = function (text) {
	return author$project$Slides$centered(
		A2(
...
var author$project$Slides$withTitle = F2(
	function (title, content) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('title-wrapper')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('slide-footer')
						]),
					_List_Nil)
				]));
	});
var author$project$Slides$mdTitle = F2(
	function (title, markdown) {
		return author$project$Slides$centered(
			A2(
				author$project$Slides$withTitle,
				title,
				A2(
					elm_explorations$markdown$Markdown$toHtml,
					_List_fromArray(
...
var author$project$Slides$titled = F2(
	function (title, content) {
		return author$project$Slides$centered(
			A2(author$project$Slides$withTitle, title, content));
	});
...
var author$project$Slides$ui = function (element) {
	return author$project$Presentation$asSlide(
		A2(
	...
	function (simMsg, comMsg) {
		return _List_fromArray(
			[
				...
				A2(author$project$Slides$mdTitle, 'Benefits of Microservices', '\n\n**Innovation**\n\nThe fact that small teams can act autonomously and choose the appropriate technologies, frameworks, and tools for their domains is an important driver for innovation. Responsibility and accountability foster a culture of ownership...\n\nhttps://docs.aws.amazon.com/aws-technical-content/latest/microservices-on-aws/benefits-of-microservices.html#innovation\n    '),
				A2(author$project$Slides$mdTitle, 'Benefits of Microservices', '\n\n**Quality**\n\nOrganizing software engineering around microservices can also improve the quality of code. The benefits of dividing software into small and well-defined modules are ... improved reusability, composability, and maintainability of code.\n\nhttps://docs.aws.amazon.com/aws-technical-content/latest/microservices-on-aws/benefits-of-microservices.html#quality\n    '),
				A2(author$project$Slides$mdTitle, 'Benefits of Microservices', '\n\n**Scalability**\n\nFine-grained decoupling of microservices is a best practice for building large-scale systems... it allows choosing the appropriate and optimal technologies... Each service can be implemented with the appropriate programming languages and frameworks...\n\nhttps://docs.aws.amazon.com/aws-technical-content/latest/microservices-on-aws/benefits-of-microservices.html#scalability\n    '),
				A2(author$project$Slides$mdTitle, 'Benefits of Microservices', '\n\n**Availability**\n\nMicroservices architectures make it easier to implement failure isolation...\n\nhttps://docs.aws.amazon.com/aws-technical-content/latest/microservices-on-aws/benefits-of-microservices.html#availability\n       '),
				A2(author$project$Slides$mdTitle, 'Challenges of Microservices', '\nAWS whitepaper divides challenges into two categories:\n* Architectural Complexity\n* Operational Complexity\n\nUIs have some features that mitigate some of these challenges:\n* UI structure is hierarchical\n* UI communication layer can be centrally managed\n* UI subsystem interactions are limited\n* UI component dependencies are typically soft\n* UI has only one consumer per machine\n* Few UI subsystems run concurrently\n        '),
				author$project$Slides$md('# A Recent History of UI Technology at Genesys'),
				author$project$Slides$ui(author$project$Content$history),
				author$project$Slides$md('# What Can We Learn From This?'),
				A2(author$project$Slides$mdTitle, 'The Cynical Take', '\n* UI developers chase fads\n* Our applications are too complex\n* We need to reduce technology churn\n* UI tools should be mandated by architects/management\n      '),
				A2(author$project$Slides$mdTitle, 'Problems With Fixed Technology', '\n* Any technology shift requires a re-write of shared tools (Agility)\n* If the mandated tech stops being maintained, you\'re in trouble (Quality, Agility)\n* Risk of developer stagnation  (Innovation)\n* Inability to use the best tool for the job (Scalability)\n* Who gets a voice in the process?\n* Who make the final decision?\n         '),
				A2(author$project$Slides$mdTitle, 'A Better Analysis', '\n* Web app development best practices are still evolving (Agility, Innovation)\n   * Virtual DOM\n   * Two-way data binding\n* We provide a diverse set of features for our customers\n   * Agent Interaction Handling, Real-time Analytics, Document Management\n      * Different SLA\'s (Quality)\n      * Different implementation challenges (Scalability)\n      * Different people\n* Acquisitions and changing business needs mean that new technology is inevitable\n* UI architectures must embrace evolution and heterogeneous systems\n       '),
				A2(author$project$Slides$mdTitle, 'PureCloud Delivery Simulation', '\n* PureCloud is designed as a single user-facing experience\n    * This is about what happens when that\'s shipped as a single artifact\n* Weekly shipping cadence\n* High SLA\n* Growing number of independent features/teams\n* These lessons will apply in other situations where independent features are embedded together\n    '),
				author$project$Slides$dynamic(
				A2(
					elm$core$Basics$composeR,
					author$project$Sim$view,
					elm$html$Html$map(simMsg))),
				A2(author$project$Slides$mdTitle, 'Lessons Learned', '\n* Coupled failures are a big problem\n    * Can drag down deployment cadence (Agility)\n    * Can also result in unexpected bugs (Quality, Availability)\n        * Dependency changes\n        * Uncaught Exceptions\n* Independent deployments and runtime isolation (like microservices) can solve these problems\n    * Problems only impact a single feature\'s deploy cadence (Agility)\n    * Runtime failure impact is limited (Availability)\n        * Not possible to crash the whole app\n        * Can only break specific integrations\n    '),
				A2(author$project$Slides$mdTitle, 'Our Approach to Common UI', '\n* Web-Components for shared UI widgets\n* Iframes for large-scale feature integration\n* Standard set of deployment tools\n    '),
				A2(author$project$Slides$mdTitle, 'Web Components (What are they?)', '\n* Web components are a combination of several browser APIs\n* They allow reusable pieces of UI to be defined as basic browser elements\n\n```\n<div class="im-a-native-element">\n    <gux-accordian class="im-a-web-component">\n        <div slot="First Section">\n            Here\'s a button: <gux-button text="Click me!"></gux-button>\n        </div>\n        <div slot="Second Section">\n            Here\'s a toggle: <gux-toggle></gux-toggle>.\n        </div>\n    </gux-accordian>\n</div>\n```\n\n       '),
				A2(author$project$Slides$mdTitle, 'Web Components', '\n* Just another DOM element\n  * Can be used _anywhere_ with _any_ framework\n  * Almost like having a library that can be consumed by any language\n  * Can be shared without re-working features\n  * Internal implementations can evolve while maintaining the external API\n\n[Documentation](https://app.gmscdev.com/common-ui-docs/genesys-webcomponents/)\n       '),
				A2(author$project$Slides$mdTitle, 'The Worst Place to Embed', '\n* A less commonly used framework\n* Not even written in JavaScript (TIOBE index 51-100)\n* Limited ability to directly call JS\n        '),
				author$project$Slides$dynamic(
				function (model) {
					return A2(
						author$project$Slides$withTitle,
				...
				author$project$Slides$md('# Development Process'),
				A2(author$project$Slides$mdTitle, 'Open Source Model', '\n* Core team\n    * Crosses PureConnect, PureEngage, and PureCloud\n    * Organize the project\n    * Review submissions\n    * Contribute to high priority items\n* External contributors\n    * Contribute to meet their needs\n    * Eventually become core members\n* Contribution isn\'t just code\n    * Docs\n    * Issues\n    * Feedback\n        '),
				A2(
				author$project$Slides$titled,
				'Core Team',
				author$project$Content$teamList(
					_List_fromArray(
						[
							_Utils_Tuple2('Jarrod Stormo', 'stormo.jpg'),
							_Utils_Tuple2('Chris Covert', 'chris.jpg'),
							_Utils_Tuple2('Jérémie Pichon', 'jeremie.jpg'),
							_Utils_Tuple2('Keri Lawrence', 'keri.jpg'),
							_Utils_Tuple2('Matt Cheely', 'matt.jpg')
						]))),
				A2(
				author$project$Slides$titled,
				'Other Contributors',
				A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('team-columns')
						]),
					_List_fromArray(
						[
							author$project$Content$teamList(
							_List_fromArray(
								[
									_Utils_Tuple2('Andy Kauffman', 'andy.jpg'),
									_Utils_Tuple2('Boris Nicolas', 'boris.jpg'),
									_Utils_Tuple2('UX Team', 'ux.jpg')
								])),
							author$project$Content$teamList(
							_List_fromArray(
								[
									_Utils_Tuple2('Justin Ray', 'justin.jpg'),
									_Utils_Tuple2('Darragh Kirwan', 'darragh.jpg'),
									_Utils_Tuple2('William Clifford', 'william.jpg')
								])),
							author$project$Content$teamList(
							_List_fromArray(
								[
									_Utils_Tuple2('You', 'you.png')
								]))
						]))),
				A2(author$project$Slides$mdTitle, 'Contributing', '\n* Get access to [PureCloud JIRA](https://inindca.atlassian.net) (sign up with your genesys email)\n* Request access to PureCloud Bitbucket\n* Read the contributing guidelines for the project\n    * [Web Components](https://bitbucket.org/inindca/genesys-webcomponents/src/master/CONTRIBUTING.md)\n* Open lines of communication with the team\n        '),
				author$project$Slides$md('# Questions?'),
				author$project$Slides$md(''),
...
var author$project$Main$ComMsg = function (a) {
	return {$: 'ComMsg', a: a};
};
var author$project$Main$SimMsg = function (a) {
	return {$: 'SimMsg', a: a};
};
var author$project$Presentation$Displaying = F3(
	function (a, b, c) {
		return {$: 'Displaying', a: a, b: b, c: c};
	});
var author$project$Presentation$create = function (slides) {
	if (slides.b) {
		var first = slides.a;
		var rest = slides.b;
		return A3(author$project$Presentation$Displaying, _List_Nil, first, rest);
	} else {
		return A3(
			author$project$Presentation$Displaying,
			_List_Nil,
			author$project$Presentation$Static(
				A2(elm$html$Html$div, _List_Nil, _List_Nil)),
			_List_Nil);
	}
};
var author$project$Sim$SimComplete = function (a) {
	return {$: 'SimComplete', a: a};
};
var author$project$Sim$YearSim = function (weeks) {
	return {weeks: weeks};
};
var author$project$Sim$WeekSim = function (projects) {
	return {projects: projects};
};
var author$project$Sim$ProjectReleaseSim = F2(
	function (majorFeature, seriousIssue) {
		return {majorFeature: majorFeature, seriousIssue: seriousIssue};
	});
...
var author$project$Sim$releaseGenerator = function (model) {
	return A3(
		elm$random$Random$map2,
		author$project$Sim$ProjectReleaseSim,
		A2(
			elm$random$Random$map,
			function (_int) {
				return _Utils_cmp(_int, model.majorFeaturePercent) < 1;
			},
			A2(elm$random$Random$int, 1, 100)),
		A2(
			elm$random$Random$map,
			function (_int) {
				return _Utils_cmp(_int, model.seriousIssuePercent) < 1;
			},
			A2(elm$random$Random$int, 1, 100)));
};
...
var author$project$Sim$releaseWeekGenerator = function (model) {
	return A2(
		elm$random$Random$map,
		author$project$Sim$WeekSim,
		A2(
			elm$random$Random$list,
			model.projectCount,
			author$project$Sim$releaseGenerator(model)));
};
var author$project$Sim$yearSimGenerator = function (model) {
	return A2(
		elm$random$Random$map,
		author$project$Sim$YearSim,
		A2(
			elm$random$Random$list,
			52,
			author$project$Sim$releaseWeekGenerator(model)));
};
...
var author$project$Sim$simulateYear = function (model) {
	return A2(
		elm$random$Random$generate,
		author$project$Sim$SimComplete,
		author$project$Sim$yearSimGenerator(model));
};
var author$project$Sim$init = function () {
	var initialModel = {buttonClicked: 0, majorFeaturePercent: 25, projectCount: 1, seriousIssuePercent: 5, simResult: elm$core$Maybe$Nothing, toggleState: false};
	return _Utils_Tuple2(
		initialModel,
		author$project$Sim$simulateYear(initialModel));
}();
var elm$core$Platform$Cmd$map = _Platform_map;
var author$project$Main$init = function (_n0) {
	var _n1 = author$project$Sim$init;
	var simModel = _n1.a;
	var simCmd = _n1.b;
	return _Utils_Tuple2(
		{
			presentationState: author$project$Presentation$create(
				A2(author$project$Content$slides, author$project$Main$SimMsg, author$project$Main$ComMsg)),
			simState: simModel
		},
		A2(elm$core$Platform$Cmd$map, author$project$Main$SimMsg, simCmd));
};
var author$project$Component$update = F2(
	function (msg, model) {
		if (msg.$ === 'ButtonClicked') {
			return _Utils_update(
				model,
				{buttonClicked: model.buttonClicked + 1});
		} else {
			var on = msg.a;
			return _Utils_update(
				model,
...
var author$project$Presentation$TransitionForward = F4(
	function (a, b, c, d) {
		return {$: 'TransitionForward', a: a, b: b, c: c, d: d};
	});
var author$project$Presentation$advance = function (presentation) {
	switch (presentation.$) {
		case 'Displaying':
			var prev = presentation.a;
			var active = presentation.b;
			var remaining = presentation.c;
			if (remaining.b) {
				var next = remaining.a;
				var future = remaining.b;
				return A4(author$project$Presentation$TransitionForward, prev, active, next, future);
			} else {
				return presentation;
			}
		case 'TransitionBack':
			var prev = presentation.a;
			var entering = presentation.b;
			var exiting = presentation.c;
			var remaining = presentation.d;
			return A4(author$project$Presentation$TransitionForward, prev, entering, exiting, remaining);
		default:
			return presentation;
	}
};
var author$project$Presentation$completeTransition = function (presentation) {
	switch (presentation.$) {
		case 'TransitionForward':
			var prev = presentation.a;
			var exiting = presentation.b;
			var entering = presentation.c;
			var future = presentation.d;
			return A3(
				author$project$Presentation$Displaying,
				A2(elm$core$List$cons, exiting, prev),
				entering,
				future);
		case 'TransitionBack':
			var prev = presentation.a;
			...
			return A3(
				...
				prev,
				entering,
				A2(elm$core$List$cons, exiting, future));
		default:
			return presentation;
	}
};
var author$project$Presentation$TransitionBack = F4(
	function (a, b, c, d) {
		return {$: 'TransitionBack', a: a, b: b, c: c, d: d};
	});
var author$project$Presentation$regress = function (presentation) {
	switch (presentation.$) {
		case 'Displaying':
			var prev = presentation.a;
			var active = presentation.b;
			...
			if (!prev.b) {
				...
				var last = prev.a;
				var previous = prev.b;
				return A4(author$project$Presentation$TransitionBack, previous, last, active, remaining);
			}
		case 'TransitionForward':
			var prev = presentation.a;
			var exiting = presentation.b;
			var entering = presentation.c;
			var remaining = presentation.d;
			return A4(author$project$Presentation$TransitionBack, prev, exiting, entering, remaining);
		default:
			return presentation;
	}
};
var author$project$Presentation$update = F2(
	function (msg, presentation) {
		switch (msg.$) {
			case 'Next':
				return author$project$Presentation$advance(presentation);
			case 'Previous':
				return author$project$Presentation$regress(presentation);
			case 'AnimationFinished':
				return author$project$Presentation$completeTransition(presentation);
			default:
				return presentation;
		}
	});
var author$project$Sim$andUpdateSim = function (model) {
	return _Utils_Tuple2(
		model,
		author$project$Sim$simulateYear(model));
};
var author$project$Sim$updateFeaturePercent = F2(
	function (model, percent) {
		return (percent < 1) ? _Utils_update(
			model,
			{majorFeaturePercent: 1}) : _Utils_update(
			model,
			{majorFeaturePercent: percent});
	});
var author$project$Sim$updateIssuePercent = F2(
	function (model, percent) {
		return (percent < 1) ? _Utils_update(
			model,
			{seriousIssuePercent: 1}) : _Utils_update(
			model,
			{seriousIssuePercent: percent});
	});
var author$project$Sim$updateProjectCount = F2(
	function (model, count) {
		return (count < 1) ? _Utils_update(
			model,
			{projectCount: 1}) : _Utils_update(
			model,
			{projectCount: count});
	});
...
var author$project$Sim$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'UpdateProjectCount':
				...
				return A2(
					...
					A2(
						...
						A2(
							elm$core$Basics$composeR,
							author$project$Sim$updateProjectCount(model),
							author$project$Sim$andUpdateSim),
						elm$core$String$toInt(string)));
			case 'UpdateFeaturePercent':
				var string = msg.a;
				return A2(
					elm$core$Maybe$withDefault,
					_Utils_Tuple2(model, elm$core$Platform$Cmd$none),
					A2(
						...
						A2(
							elm$core$Basics$composeR,
							author$project$Sim$updateFeaturePercent(model),
							author$project$Sim$andUpdateSim),
						elm$core$String$toInt(string)));
			case 'UpdateIssuePercent':
				var string = msg.a;
				return A2(
					elm$core$Maybe$withDefault,
					_Utils_Tuple2(model, elm$core$Platform$Cmd$none),
					A2(
						...
						A2(
							elm$core$Basics$composeR,
							author$project$Sim$updateIssuePercent(model),
							author$project$Sim$andUpdateSim),
						elm$core$String$toInt(string)));
			case 'SimComplete':
				var yearSim = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							simResult: elm$core$Maybe$Just(yearSim)
						}),
					elm$core$Platform$Cmd$none);
			default:
				return author$project$Sim$andUpdateSim(model);
		}
	});
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'PresentAction':
				var presentMsg = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							presentationState: A2(author$project$Presentation$update, presentMsg, model.presentationState)
						}),
					elm$core$Platform$Cmd$none);
			case 'SimMsg':
				var simMsg = msg.a;
				var _n1 = A2(author$project$Sim$update, simMsg, model.simState);
				var newModel = _n1.a;
				var cmd = _n1.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{simState: newModel}),
					A2(elm$core$Platform$Cmd$map, author$project$Main$SimMsg, cmd));
			default:
				var comMsg = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							simState: A2(author$project$Component$update, comMsg, model.simState)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$Presentation$slideStyle = function (attrs) {
	return _Utils_ap(
		_List_fromArray(
			[
...
var author$project$Presentation$toHtml = F2(
...
var author$project$Presentation$hiddenSlide = F2(
	function (model, slide) {
		return A2(
			elm$html$Html$div,
			author$project$Presentation$slideStyle(
				_List_fromArray(
					[
						_Utils_Tuple2('margin-left', '-100vw')
					])),
			_List_fromArray(
				[
					A2(author$project$Presentation$toHtml, slide, model)
				]));
	});
var author$project$Presentation$AnimationFinished = {$: 'AnimationFinished'};
var author$project$Presentation$transition = _Utils_Tuple2('transition', '0.5s');
var author$project$Presentation$leavingLeft = F3(
	function (msgConvert, model, slide) {
		return A2(
			elm$html$Html$div,
			_Utils_ap(
				author$project$Presentation$slideStyle(
					_List_fromArray(
						[
							_Utils_Tuple2('margin-left', '-100vw'),
							author$project$Presentation$transition
						])),
				_List_fromArray(
					[
						A2(
						...
						elm$json$Json$Decode$succeed(
							msgConvert(author$project$Presentation$AnimationFinished)))
					])),
			_List_fromArray(
				[
					A2(author$project$Presentation$toHtml, slide, model)
...
var author$project$Presentation$returningLeft = F3(
	function (msgConvert, model, slide) {
		return A2(
			elm$html$Html$div,
			_Utils_ap(
...
var author$project$Presentation$visibleSlide = F2(
	function (model, slide) {
		return A2(
			elm$html$Html$div,
			author$project$Presentation$slideStyle(_List_Nil),
			_List_fromArray(
				[
					A2(author$project$Presentation$toHtml, slide, model)
				]));
	});
var author$project$Presentation$showPresentation = F3(
	function (msgConvert, presentation, model) {
		switch (presentation.$) {
			case 'Displaying':
				var previous = presentation.a;
				var active = presentation.b;
				var remaining = presentation.c;
				return _Utils_ap(
					A2(
						elm$core$List$map,
						author$project$Presentation$hiddenSlide(model),
						previous),
					A2(
						elm$core$List$map,
						author$project$Presentation$visibleSlide(model),
						A2(elm$core$List$cons, active, remaining)));
			case 'TransitionForward':
				var previous = presentation.a;
				var exiting = presentation.b;
				var entering = presentation.c;
				...
				return _Utils_ap(
					...
					_Utils_ap(
						_List_fromArray(
							[
								A3(author$project$Presentation$leavingLeft, msgConvert, model, exiting)
							]),
						A2(
							elm$core$List$map,
							author$project$Presentation$visibleSlide(model),
							A2(elm$core$List$cons, entering, remaining))));
			default:
				var previous = presentation.a;
				var entering = presentation.b;
				var exiting = presentation.c;
				...
				return _Utils_ap(
					...
					_Utils_ap(
						_List_fromArray(
							[
								A3(author$project$Presentation$returningLeft, msgConvert, model, entering)
							]),
						A2(
							elm$core$List$map,
							author$project$Presentation$visibleSlide(model),
							A2(elm$core$List$cons, exiting, remaining))));
		}
	});
var author$project$Presentation$view = F3(
	function (msgConvert, presentation, model) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
			...
			A3(author$project$Presentation$showPresentation, msgConvert, presentation, model));
	});
var author$project$Main$view = function (model) {
	return A3(author$project$Presentation$view, author$project$Main$PresentAction, model.presentationState, model.simState);
};
var author$project$Presentation$Next = {$: 'Next'};
var author$project$Presentation$NoOp = {$: 'NoOp'};
var author$project$Presentation$Previous = {$: 'Previous'};
var author$project$Presentation$toDirection = function (string) {
	switch (string) {
		case 'ArrowLeft':
			return author$project$Presentation$Previous;
		case 'ArrowRight':
			return author$project$Presentation$Next;
		default:
			return author$project$Presentation$NoOp;
	}
};
var author$project$Presentation$keyDecoder = A2(
	elm$json$Json$Decode$map,
	author$project$Presentation$toDirection,
...
var author$project$Presentation$subscriptions = elm$browser$Browser$Events$onKeyDown(author$project$Presentation$keyDecoder);
var elm$browser$Browser$element = _Browser_element;
var author$project$Main$main = elm$browser$Browser$element(
	{
		init: author$project$Main$init,
		subscriptions: function (_n0) {
			return A2(elm$core$Platform$Sub$map, author$project$Main$PresentAction, author$project$Presentation$subscriptions);
		},
		update: author$project$Main$update,
		view: author$project$Main$view
	});
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Sim.ProjectReleaseSim":{"args":[],"type":"{ majorFeature : Basics.Bool, seriousIssue : Basics.Bool }"},"Sim.WeekSim":{"args":[],"type":"{ projects : List.List Sim.ProjectReleaseSim }"},"Sim.YearSim":{"args":[],"type":"{ weeks : List.List Sim.WeekSim }"}},"unions":{"Main.Msg":{"args":[],"tags":{"PresentAction":["Presentation.Msg"],"SimMsg":["Sim.Msg"],"ComMsg":["Component.Msg"]}},"Component.Msg":{"args":[],"tags":{"ButtonClicked":[],"ToggleFlipped":["Basics.Bool"]}},"Presentation.Msg":{"args":[],"tags":{"Previous":[],"Next":[],"AnimationFinished":[],"NoOp":[]}},"Sim.Msg":{"args":[],"tags":{"UpdateProjectCount":["String.String"],"UpdateFeaturePercent":["String.String"],"UpdateIssuePercent":["String.String"],"SimComplete":["Sim.YearSim"],"DoSim":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"List.List":{"args":["a"],"tags":{}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
...
},{}],"../node_modules/@genesys/common-webcomponents/dist/genesys-webcomponents.js":[function(require,module,exports) {
/*!
 * Built with http://stenciljs.com
 * 2019-02-20T19:32:21
 */
!function(e,t,n,s,o,r,i,u,c,a,p,l,d,g){for(p=e[n]=e[n]||{},(l=t.createElement("style")).innerHTML=c+"{visibility:hidden}.hydrated{visibility:inherit}",l.setAttribute("data-styles",""),d=t.head.querySelector("meta[charset]"),t.head.insertBefore(l,d?d.nextSibling:t.head.firstChild),function(e,t,n){(e["s-apps"]=e["s-apps"]||[]).push("GenesysWebcomponents"),n.componentOnReady||(n.componentOnReady=function(){var t=this;function n(n){if(t.nodeName.indexOf("-")>0){for(var s=e["s-apps"],o=0,r=0;r<s.length;r++)if(e[s[r]].componentOnReady){if(e[s[r]].componentOnReady(t,n))return;o++}if(o<s.length)return void(e["s-cr"]=e["s-cr"]||[]).push([t,n])}n(null)}return e.Promise?new e.Promise(n):{then:n}})}(e,0,a),o=o||p.resourcesUrl,l=(d=t.querySelectorAll("script")).length-1;l>=0&&!(g=d[l]).src&&!g.hasAttribute("data-resources-url");l--);d=g.getAttribute("data-resources-url"),!o&&d&&(o=d),!o&&g.src&&(o=(d=g.src.split("/").slice(0,-1)).join("/")+(d.length?"/":"")+"genesys-webcomponents/"),l=t.createElement("script"),function(e,t,n,s){return!(t.search.indexOf("core=esm")>0)&&(!(!(t.search.indexOf("core=es5")>0||"file:"===t.protocol)&&e.customElements&&e.customElements.define&&e.fetch&&e.CSS&&e.CSS.supports&&e.CSS.supports("color","var(--c)")&&"noModule"in n)||function(e){try{return new Function('import("")'),!1}catch(e){}return!0}())}(e,e.location,l)?l.src=o+"genesys-webcomponents.wh0btsub.js":(l.src=o+"genesys-webcomponents.sm6rb23d.js",l.setAttribute("type","module"),l.setAttribute("crossorigin",!0)),l.setAttribute("data-resources-url",o),l.setAttribute("data-namespace","genesys-webcomponents"),t.head.appendChild(l)}(window,document,"GenesysWebcomponents",0,0,0,0,0,"gux-accordion,gux-action-button,gux-action-toast,gux-button,gux-disclosure-button,gux-dropdown,gux-list,gux-notification-toast,gux-pagination,gux-pagination-buttons,gux-pagination-item-counts,gux-pagination-items-per-page,gux-rating,gux-simple-toast,gux-slider,gux-text-field,gux-toggle,gux-tooltip",HTMLElement.prototype);
},{}],"js/app.js":[function(require,module,exports) {
"use strict";

var _Main = require("../elm/Main.elm");

var components = _interopRequireWildcard(require("../../node_modules/@genesys/common-webcomponents/dist/genesys-webcomponents.js"));
...
},{"../elm/Main.elm":"elm/Main.elm","../../node_modules/@genesys/common-webcomponents/dist/genesys-webcomponents.js":"../node_modules/@genesys/common-webcomponents/dist/genesys-webcomponents.js"}],"../node_modules/parcel-bundler-fork/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler-fork/src/builtins/hmr-runtime.js","js/app.js"], null)
