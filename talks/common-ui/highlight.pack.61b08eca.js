...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/highlight/highlight.pack.js":[function(require,module,exports) {
var define;
...
!function (e) {
  ...
  "undefined" != typeof undefined ? e(exports) : n && (n.hljs = e({}), "function" == typeof define && define.amd && define([], function () {
    return n.hljs;
  }));
}(function (a) {
  var E = [],
  ...
  function C(e, n, o, t) {
    ...
    function s() {
      g += null != E.sL ? function () {
        ...
        for (r = "", n = 0, E.lR.lastIndex = 0, t = E.lR.exec(R); t;) {
          r += _(R.substring(n, t.index)), a = E, i = t, c = f.cI ? i[0].toLowerCase() : i[0], (e = a.k.hasOwnProperty(c) && a.k[c]) ? (d += e[1], r += u(e[0], _(t[0]))) : r += _(t[0]), n = E.lR.lastIndex, t = E.lR.exec(R);
        }
    ...
    try {
      ...
      for (r(n.substr(M)), a = E; a.parent; a = a.parent) {
        a.cN && (g += b);
      }
...
},{}]},{},["../node_modules/parcel-bundler-fork/src/builtins/hmr-runtime.js","js/highlight/highlight.pack.js"], null)
//# sourceMappingURL=/highlight.pack.61b08eca.js.map