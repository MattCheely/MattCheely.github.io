...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Presentation.Msg":{"args":[],"tags":{"Next":[],"AnimationFinished":[],"NoOp":[],"Previous":[]}},"Main.Msg":{"args":[],"tags":{"PresentAction":["Presentation.Msg"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
...
var _user$project$Sim$calculateBugImpact = function (model) {
	...
	var majorFeatureRate = _elm_lang$core$Basics$toFloat(model.majorFeaturePercent) / 100;
	var expectedFeaturesPerWeek = majorFeatureRate * projectCount;
	...
	var noRollbackProbability = Math.pow(1 - seriousIssueRate, projectCount);
	var rollbackProbability = 1 - noRollbackProbability;
	var expectedFeatureDelays = (rollbackProbability * expectedFeaturesPerWeek) * 52;
	return {weeklyRollbackProbability: rollbackProbability, expectedYearlyFeatures: expectedYearlyFeatures, expectedFeatureDelays: expectedFeatureDelays, impactedFeaturePercent: (expectedFeatureDelays / expectedYearlyFeatures) * 100};
};
var _user$project$Sim$statsView = function (model) {
	return _elm_lang$html$Html$text(
		_elm_lang$core$Basics$toString(
			_user$project$Sim$calculateBugImpact(model)));
};
...
var _user$project$Sim$weekVis = function (weekSim) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Sim$simVis = function (sim) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(_elm_lang$core$List$map, _user$project$Sim$weekVis, sim.weeks));
};
...
var _user$project$Sim$simStats = function (sim) {
	var impactedFeatureCount = _elm_lang$core$List$sum(
		A2(
			_elm_lang$core$List$map,
			_user$project$Sim$weekFeatureCount,
			A2(_elm_lang$core$List$filter, _user$project$Sim$hasIssue, sim.weeks)));
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Features Built'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(featureCount)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Features Impacted By Issues'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_elm_lang$core$Basics$toString(impactedFeatureCount)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Sim$simView = function (sim) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Sim$simStats(sim),
			_1: {
				ctor: '::',
				_0: _user$project$Sim$simVis(sim),
				_1: {ctor: '[]'}
			}
		});
};
					...
					A2(
						...
						function (_p1) {
							return _user$project$Sim$andUpdateSim(
								A2(_user$project$Sim$updateProjectCount, model, _p1));
						},
			...
			case 'UpdateFeaturePercent':
				return A2(
					...
					A2(
						...
						function (_p2) {
							return _user$project$Sim$andUpdateSim(
								A2(_user$project$Sim$updateFeaturePercent, model, _p2));
						},
						_elm_lang$core$String$toInt(_p0._0)));
			case 'UpdateIssuePercent':
				return A2(
					...
					A2(
						...
						function (_p3) {
							return _user$project$Sim$andUpdateSim(
								A2(_user$project$Sim$updateIssuePercent, model, _p3));
						},
						_elm_lang$core$String$toInt(_p0._0)));
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							simResult: _elm_lang$core$Maybe$Just(_p0._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
...
var _user$project$Sim$issuePercentSetting = function (issuePercent) {
	return _user$project$Sim$intSetting(
		{
			label: 'Breaking Issue Probability',
			id: 'issueProb',
			min: 1,
			max: 100,
...
var _user$project$Sim$featureShipRateSetting = function (featurePercent) {
	return _user$project$Sim$intSetting(
		{
			label: 'Major Feature Release Probability',
			id: 'featureProb',
			min: 1,
			max: 100,
...
var _user$project$Sim$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Sim$statsView(model),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$core$Maybe$withDefault,
						_elm_lang$html$Html$text(''),
						A2(_elm_lang$core$Maybe$map, _user$project$Sim$simView, model.simResult)),
					_1: {ctor: '[]'}
				}
			}
		});
...
if (typeof _user$project$Sim$main !== 'undefined') {
    _user$project$Sim$main(Elm['Sim'], 'Sim', {"types":{"unions":{"Sim.Msg":{"args":[],"tags":{"UpdateProjectCount":["String"],"UpdateFeaturePercent":["String"],"UpdateIssuePercent":["String"],"SimComplete":["Sim.YearSim"]}}},"aliases":{"Sim.ProjectReleaseSim":{"args":[],"type":"{ majorFeature : Bool, seriousIssue : Bool }"},"Sim.WeekSim":{"args":[],"type":"{ projects : List Sim.ProjectReleaseSim }"},"Sim.YearSim":{"args":[],"type":"{ weeks : List Sim.WeekSim }"}},"message":"Sim.Msg"},"versions":{"elm":"0.18.0"}});
}
